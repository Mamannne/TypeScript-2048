...
function count(f1:Function ): boolean {
    let count = 0;
    for(let i = 0; i<4; i++){
        let flag = f1(i);
        if (flag == true){
...
class Popup {
    ...
    constructor(str: string, end: boolean = false) {
